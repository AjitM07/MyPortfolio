                ...
                <div className="flex gap-4 mt-auto w-full">
                  {project.liveLink && (
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2.5 bg-accent hover:bg-white text-bg-primary font-semibold text-sm px-4 py-2.5 rounded-lg transition-all duration-200 cursor-none shadow-md shadow-black/10"
                    >
                  ...
                  {project.githubLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-2.5 border border-white/10 hover:border-white/20 hover:bg-white/5 text-white font-medium text-sm px-4 py-2.5 rounded-lg transition-all duration-200 cursor-none"
                    >
